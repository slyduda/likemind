<template>
  ...
  >
    ...
    <path
      fill="currentColor"
      fill-rule="evenodd"
      d="M18.75 16.5a2.25 2.25 0 1 0 0 4.5a2.25 2.25 0 0 0 0-4.5M15 18.75a3.75 3.75 0 1 1 6.879 2.068l1.401 1.402a.75.75 0 1 1-1.06 1.06l-1.402-1.401A3.75 3.75 0 0 1 15 18.75"
      clip-rule="evenodd"
    />
  </svg>
</template>
